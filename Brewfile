...
cask "aerospace"              # Tiling window manager (i3-inspired)
brew "borders"                # Window border highlights (used by aerospace)
...
cask "setapp"             # App subscription service
